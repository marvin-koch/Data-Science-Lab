...
def main(args):
    ...
    reference_unet, unet, optimizer, train_dataloader, lr_scheduler = accelerator.prepare(
        reference_unet, unet, optimizer, train_dataloader, lr_scheduler
    )
