...
FINETUNED_MODEL_DIR = "models_finetuned" # Directory to save fine-tuned models
BASE_IMAGE_DIR = "images_finetuned"
BASE_METADATA_DIR = "metadata_finetuned"
BASE_ORDER_RESULTS_DIR = "order_results_finetuned"
# IMPORTANT: Set your HF Token and Repo Name
# Load from environment variable if possible
HF_TOKEN = os.getenv("HF_TOKEN")
HF_REPO_BASE_NAME = "MarvinKoch/onlinetest_finetuned" # CHANGE THIS default or set env var
...
def fine_tune_model(base_model_path: str, feedback_dataset_repo_id: str, iteration_num: int, output_dir_base: str, lora_model_path: str,) -> str:
    ...
    train_batch_size=8, # Default was 4
    ...
    learning_rate=5e-6, # Default was 5e-4
    lr_scheduler="cosine", # Default was "constant" (no change here, but listed for completeness)
    lr_warmup_steps=200, # Default was 500
...
def run_training_loop():
    ...
    lora_model_path = "models_finetuned/sdxl_LORA_finetuned_iter_2"  # Start with the base model
    ...
    for i in range(3, NUM_ITERATIONS):
        ...
        try:
            ...
            if i > 0:
                ...
                feedback_repo_id = "MarvinKoch/onlinetest_finetuned-iter-0"
