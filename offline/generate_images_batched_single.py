...
PROMPTS_TXT = os.path.join("prompts_validation.txt") # Assuming prompts.txt is in the root directory
...
# pipe.load_lora_weights(pretrained_model_name_or_path_or_dict="../lora_training/sdxl-logo/checkpoint-3000", weight_name="pytorch_lora_weights.safetensors")
...
def generate_images_batched(batch_size=4):
    ...
    with open(PROMPTS_TXT, "r") as f:
        ...
        # prompts = [p + "LogoRedAF" for p in prompts]
        ...
        for i in range(0, len(prompts), batch_size):
            ...
            try:
                ...
                for j, prompt in enumerate(batch_prompts):
                    ...
                    print(f"  ✅ Saved: {image_id1}, for prompt: \"{prompt[:50]}...\"")
